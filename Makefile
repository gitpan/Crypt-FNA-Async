...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Crypt/FNA/Async.pm
...
TO_INST_PM = lib/Crypt/FNA/Async.pm

PM_TO_BLIB = lib/Crypt/FNA/Async.pm \
...
DISTVNAME = Crypt-FNA-Async-0.04
...
FNA.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Crypt::FNA::Async\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	lib/Crypt/FNA/Async.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Crypt/FNA/Async.pm $(INST_MAN3DIR)\Crypt.FNA.Async.$(MAN3EXT)
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', '$(PM_FILTER)')" -- \
	  lib/Crypt/FNA/Async.pm blib\lib\Crypt\FNA\Async.pm 
